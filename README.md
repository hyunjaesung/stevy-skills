...
생각을 명료하게 만들고, 학습·투자·지식관리·인생 의사결정을 돕는 재사용 가능한 AI 에이전트 스킬 모음입니다. 하나의 `SKILL.md` 원본을 Codex와 Claude Code에서 함께 사용합니다.
...
| `personal-cabinet` | 여러 전문 관점이 필요한 문제를 개인 내각 방식으로 조율 |
| `education-ministry` | 학습 목표, 커리큘럼, 연습, 복습과 숙달 관리 |
| `asset-ministry` | 자산·현금흐름·포트폴리오·투자일지 검토 |
| `creativity-ministry` | 아이디어 확장, 재구성, 실험 설계 |
| `ai-ministry` | AI 도구·에이전트·자동화·평가·보안 의사결정 |
| `life-ministry` | 목표·습관·시간·관계·커리어 등 삶 전반의 선택 지원 |
